...
const config = {
  title: 'Fachinformatiker Azubi Wiki',
  // tagline: 'Dinosaurs are cool',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://fachinformatiker-azubi.de',
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'Fachinformatiker Azubi',
        logo: {
          alt: 'Fachinformatiker Azubi Logo',
          src: 'img/logo.svg',
        },
        items: [
          // {
      ...
      footer: {
        ...
        //   },
        // ],
        copyright: `Copyright © ${new Date().getFullYear()} Alcodo UG (haftungsbeschränkt). Alle Rechte vorbehalten.`,
      },
      prism: {
